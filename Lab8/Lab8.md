...
# apps-all-in-one.yaml code for task 1
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: order-service
          image: matthewclouddev/order-service:latest # Custom image for order service
          ports:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: makeline-service
          image: matthewclouddev/makeline-service:latest # Custom Makeline service image
          ports:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: product-service
          image: matthewclouddev/product-service:latest # Custom product service image
          ports:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: store-front
          image: matthewclouddev/store-front:latest # Front-end store application
          ports:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: store-admin
          image: matthewclouddev/store-admin:latest # Admin interface for store
          ports:
